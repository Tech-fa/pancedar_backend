...
@Global()
@Module({
  imports: [TypeOrmModule.forFeature([History]), QueueModule, PermissionModule],
  controllers: [HistoryController],
  providers: [HistoryService, HistorySubscriber, RequestContextService, HistoryInterceptor, HistoryQueueHandler],
